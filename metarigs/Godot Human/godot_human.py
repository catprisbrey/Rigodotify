...
def create(obj):  # noqa
    ...
    bone.head = 0.0000, 0.0501, 0.9167
    bone.tail = 0.1397, -0.0527, 1.0394
    bone.roll = -0.8850
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine']]
    ...
    bone.tail = -0.0000, 0.0085, 1.5296
    bone.roll = 0.0000
    bone.use_connect = False
    ...
    bone.head = -0.0000, 0.0085, 1.5296
    bone.tail = -0.0000, -0.0077, 1.5778
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = -0.0000, -0.0077, 1.5778
    bone.tail = -0.0000, -0.0117, 1.7980
    bone.roll = -0.0000
    bone.use_connect = True
    ...
    bone.head = -0.0000, -0.1028, 1.5756
    bone.tail = -0.0000, -0.2487, 1.5103
    bone.roll = -0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.006']]
    bones['jaw'] = bone.name
    bone = arm.edit_bones.new('eye.L')
    bone.head = 0.0400, -0.1218, 1.6695
    bone.tail = 0.0400, -0.1862, 1.6696
    bone.roll = -0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.006']]
    ...
    bone.head = 0.7770, 0.0344, 1.4388
    bone.tail = 0.8588, 0.0345, 1.4388
    bone.roll = -3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['palm.01.L'] = bone.name
    bone = arm.edit_bones.new('palm.02.L')
    bone.head = 0.7790, 0.0565, 1.4412
    bone.tail = 0.8605, 0.0602, 1.4412
    bone.roll = -3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['palm.02.L'] = bone.name
    bone = arm.edit_bones.new('palm.03.L')
    bone.head = 0.7774, 0.0796, 1.4409
    bone.tail = 0.8580, 0.0825, 1.4409
    bone.roll = -3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['palm.03.L'] = bone.name
    bone = arm.edit_bones.new('palm.04.L')
    bone.head = 0.7734, 0.1012, 1.4392
    bone.tail = 0.8466, 0.1062, 1.4392
    bone.roll = -3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
