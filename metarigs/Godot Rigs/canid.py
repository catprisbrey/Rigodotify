...
def create(obj):  # noqa
    ...
    bone.head = -0.0000, 0.4101, 0.7915
    bone.tail = -0.0000, 0.2214, 0.7911
    bone.roll = 0.0000
    bone.use_connect = False
    bones['spine'] = bone.name
    bone = arm.edit_bones.new('spine.001')
    bone.head = -0.0000, 0.2214, 0.7911
    bone.tail = -0.0000, 0.0474, 0.7800
    bone.roll = 0.0000
    ...
    bone.head = -0.0000, 0.4429, 0.7848
    bone.tail = -0.0000, 0.5545, 0.7586
    bone.roll = -0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine']]
    bones['tail'] = bone.name
    bone = arm.edit_bones.new('spine.002')
    bone.head = -0.0000, 0.0474, 0.7800
    ...
    bone.head = -0.0000, 0.5545, 0.7586
    bone.tail = -0.0000, 0.6720, 0.7467
    bone.roll = -0.0000
    bone.use_connect = True
    ...
    bone.tail = 0.0000, -0.3599, 0.8336
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.tail = 0.1201, 0.4131, 0.0000
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = -0.0000, 0.6720, 0.7467
    bone.tail = -0.0000, 0.7782, 0.7385
    bone.roll = -0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['tail.001']]
    bones['tail.002'] = bone.name
    bone = arm.edit_bones.new('spine.004')
    bone.head = 0.0000, -0.3599, 0.8336
    bone.tail = 0.0000, -0.4866, 0.8807
    bone.roll = 0.0000
    bone.use_connect = False
    ...
    bone.head = 0.1201, 0.4131, 0.0000
    ...
    bone.head = -0.0000, 0.7782, 0.7385
    bone.tail = -0.0000, 0.8853, 0.7408
    bone.roll = -0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['tail.002']]
    bones['tail.003'] = bone.name
    bone = arm.edit_bones.new('spine.005')
    bone.head = 0.0000, -0.4866, 0.8807
    bone.tail = 0.0000, -0.8095, 0.8567
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = -0.0000, 0.8853, 0.7408
    bone.tail = 0.0000, 0.9992, 0.7425
    bone.roll = -0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['tail.003']]
    bones['tail.004'] = bone.name
    bone = arm.edit_bones.new('jaw')
    bone.head = 0.0000, -0.6854, 0.8174
    bone.tail = 0.0000, -0.7722, 0.7978
    bone.roll = 0.0000
    bone.use_connect = False
    ...
    bone.head = 0.0000, 0.9992, 0.7425
    bone.tail = 0.0000, 1.1051, 0.7613
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.tail = 0.1220, -0.2446, 0.0000
    bone.roll = -3.0599
    bone.use_connect = True
    ...
    bone.head = 0.1220, -0.2446, 0.0000
