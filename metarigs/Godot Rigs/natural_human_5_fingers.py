...
def create(obj):  # noqa
    ...
    bone.tail = 0.0000, 0.0195, 1.0767
    bone.roll = 0.0000
    bone.use_connect = False
    bones['spine'] = bone.name
    bone = arm.edit_bones.new('spine.001')
    bone.head = 0.0000, 0.0195, 1.0767
    bone.tail = 0.0000, 0.0057, 1.1908
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine']]
    bones['spine.001'] = bone.name
    bone = arm.edit_bones.new('thigh.L')
    bone.head = 0.0983, -0.0015, 0.9376
    ...
    bone.head = 0.0000, 0.0057, 1.1908
    ...
    bone.tail = 0.0000, 0.0149, 1.5228
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, 0.0149, 1.5228
    bone.tail = 0.0000, 0.0007, 1.5955
    bone.roll = 0.0000
    bone.use_connect = False
    ...
    bone.head = 0.0000, 0.0007, 1.5955
    ...
    bone.tail = 0.7597, 0.0403, 1.4664
    bone.roll = 1.6525
    bone.use_connect = True
    ...
    bone.head = 0.7826, 0.0122, 1.4633
    bone.tail = 0.8139, 0.0111, 1.4633
    bone.roll = 3.1416
    bone.use_connect = False
    ...
    bone.head = 0.7847, 0.0319, 1.4652
    bone.tail = 0.8172, 0.0322, 1.4652
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_middle.01.L'] = bone.name
    bone = arm.edit_bones.new('f_ring.01.L')
    bone.head = 0.7834, 0.0490, 1.4649
    bone.tail = 0.8135, 0.0490, 1.4649
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_ring.01.L'] = bone.name
    bone = arm.edit_bones.new('f_pinky.01.L')
    bone.head = 0.7753, 0.0675, 1.4636
    bone.tail = 0.8062, 0.0685, 1.4636
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    ...
    bone.head = 0.8139, 0.0111, 1.4633
    bone.tail = 0.8406, 0.0101, 1.4633
    bone.roll = 3.1416
    bone.use_connect = True
    ...
    bone.head = 0.8406, 0.0101, 1.4633
    bone.tail = 0.8636, 0.0093, 1.4633
    bone.roll = 3.1416
    bone.use_connect = True
