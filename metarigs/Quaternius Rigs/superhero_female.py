...
def create(obj):  # noqa
    ...
    bone.head = 0.0000, 0.0457, 0.9318
    bone.tail = 0.0000, 0.0151, 1.0546
    bone.roll = 0.0000
    bone.use_connect = False
    bones['spine'] = bone.name
    bone = arm.edit_bones.new('spine.001')
    bone.head = 0.0000, 0.0151, 1.0546
    bone.tail = 0.0000, 0.0023, 1.1642
    bone.roll = 0.0001
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine']]
    bones['spine.001'] = bone.name
    bone = arm.edit_bones.new('thigh.L')
    bone.head = 0.1114, 0.0518, 0.9441
    bone.tail = 0.1114, 0.0323, 0.5347
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine']]
    ...
    bone.head = 0.0000, 0.0023, 1.1642
    bone.tail = 0.0000, 0.0017, 1.2906
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.001']]
    bones['spine.002'] = bone.name
    bone = arm.edit_bones.new('shin.L')
    bone.head = 0.1114, 0.0323, 0.5347
    bone.tail = 0.1114, 0.0765, 0.0707
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, 0.0017, 1.2906
    bone.tail = 0.0000, 0.0406, 1.4849
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.002']]
    bones['spine.003'] = bone.name
    bone = arm.edit_bones.new('foot.L')
    bone.head = 0.1114, 0.0765, 0.0707
    bone.tail = 0.1114, -0.0618, 0.0148
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, 0.0406, 1.4849
    bone.tail = 0.0000, 0.0109, 1.5496
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.003']]
    bones['spine.004'] = bone.name
    bone = arm.edit_bones.new('shoulder.L')
    bone.head = 0.0293, -0.0160, 1.4305
    bone.tail = 0.1372, 0.0444, 1.4304
    bone.roll = 0.0005
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.003']]
    ...
    bone.head = 0.1114, -0.0618, 0.0148
    bone.tail = 0.1114, -0.1299, 0.0148
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['foot.L']]
    bones['toe.L'] = bone.name
    bone = arm.edit_bones.new('heel.02.L')
    bone.head = 0.0778, 0.0769, 0.0000
    bone.tail = 0.1484, 0.0769, 0.0000
    bone.roll = -0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['foot.L']]
    ...
    bone.head = 0.0000, 0.0109, 1.5496
    bone.tail = 0.0000, 0.0071, 1.7597
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.004']]
    bones['spine.005'] = bone.name
    bone = arm.edit_bones.new('upper_arm.L')
    bone.head = 0.1516, 0.0543, 1.4181
    bone.tail = 0.3919, 0.0588, 1.4181
    bone.roll = 1.5699
    bone.use_connect = False
    ...
    bone.head = 0.3919, 0.0588, 1.4181
    bone.tail = 0.6411, 0.0516, 1.4181
    bone.roll = 1.5708
    bone.use_connect = True
    ...
    bone.head = 0.6411, 0.0516, 1.4181
    bone.tail = 0.7041, 0.0526, 1.4181
    bone.roll = 1.6525
    bone.use_connect = True
    ...
    bone.head = 0.7299, 0.0168, 1.4139
    bone.tail = 0.7616, 0.0176, 1.4139
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_index.01.L'] = bone.name
    bone = arm.edit_bones.new('thumb.01.L')
    bone.head = 0.6387, 0.0216, 1.4081
    bone.tail = 0.6672, 0.0085, 1.3908
    bone.roll = -1.0131
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['thumb.01.L'] = bone.name
    bone = arm.edit_bones.new('f_middle.01.L')
    bone.head = 0.7276, 0.0423, 1.4162
    bone.tail = 0.7640, 0.0437, 1.4162
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_middle.01.L'] = bone.name
    bone = arm.edit_bones.new('f_ring.01.L')
    bone.head = 0.7213, 0.0667, 1.4159
    bone.tail = 0.7563, 0.0670, 1.4159
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_ring.01.L'] = bone.name
    bone = arm.edit_bones.new('f_pinky.01.L')
    bone.head = 0.7105, 0.0867, 1.4143
    bone.tail = 0.7413, 0.0881, 1.4143
    bone.roll = 3.1416
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
