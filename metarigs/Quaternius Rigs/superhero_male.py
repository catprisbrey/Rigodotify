...
def create(obj):  # noqa
    ...
    bone.head = 0.0000, 0.0430, 0.9491
    bone.tail = 0.0000, 0.0069, 1.0720
    bone.roll = -0.0000
    bone.use_connect = False
    bones['spine'] = bone.name
    bone = arm.edit_bones.new('spine.001')
    bone.head = 0.0000, 0.0069, 1.0720
    bone.tail = 0.0000, -0.0039, 1.1778
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine']]
    bones['spine.001'] = bone.name
    bone = arm.edit_bones.new('thigh.L')
    bone.head = 0.1143, 0.0360, 0.9712
    bone.tail = 0.1143, 0.0361, 0.5424
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine']]
    ...
    bone.head = 0.0000, -0.0039, 1.1778
    bone.tail = 0.0000, -0.0069, 1.3109
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.001']]
    bones['spine.002'] = bone.name
    bone = arm.edit_bones.new('shin.L')
    bone.head = 0.1143, 0.0361, 0.5424
    bone.tail = 0.1143, 0.0875, 0.0865
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, -0.0069, 1.3109
    bone.tail = 0.0000, 0.0414, 1.5205
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.002']]
    bones['spine.003'] = bone.name
    bone = arm.edit_bones.new('foot.L')
    bone.head = 0.1143, 0.0875, 0.0865
    bone.tail = 0.1143, -0.0547, 0.0152
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, 0.0414, 1.5205
    bone.tail = 0.0000, 0.0174, 1.5998
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.003']]
    bones['spine.004'] = bone.name
    bone = arm.edit_bones.new('shoulder.L')
    bone.head = 0.0314, -0.0335, 1.4953
    bone.tail = 0.1751, 0.0371, 1.4952
    bone.roll = 0.0004
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.003']]
    ...
    bone.head = 0.1143, -0.0547, 0.0152
    bone.tail = 0.1143, -0.1336, 0.0152
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['foot.L']]
    bones['toe.L'] = bone.name
    bone = arm.edit_bones.new('heel.02.L')
    bone.head = 0.0798, 0.0791, 0.0000
    bone.tail = 0.1524, 0.0791, 0.0000
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['foot.L']]
    ...
    bone.head = 0.0000, 0.0174, 1.5998
    bone.tail = 0.0000, 0.0115, 1.8034
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.004']]
    bones['spine.005'] = bone.name
    bone = arm.edit_bones.new('upper_arm.L')
    bone.head = 0.2120, 0.0654, 1.4555
    bone.tail = 0.4630, 0.0730, 1.4555
    bone.roll = 1.5699
    bone.use_connect = False
    ...
    bone.head = 0.4630, 0.0730, 1.4555
    bone.tail = 0.7065, 0.0654, 1.4555
    bone.roll = 1.6030
    bone.use_connect = True
    ...
    bone.head = 0.7065, 0.0654, 1.4555
    bone.tail = 0.8024, 0.0654, 1.4555
    bone.roll = 1.6525
    bone.use_connect = True
    ...
    bone.head = 0.8239, 0.0248, 1.4483
    bone.tail = 0.8565, 0.0252, 1.4471
    bone.roll = -3.1039
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_index.01.L'] = bone.name
    bone = arm.edit_bones.new('thumb.01.L')
    bone.head = 0.7403, 0.0243, 1.4280
    bone.tail = 0.7714, 0.0093, 1.4088
    bone.roll = -0.7854
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['thumb.01.L'] = bone.name
    bone = arm.edit_bones.new('f_middle.01.L')
    bone.head = 0.8219, 0.0503, 1.4508
    bone.tail = 0.8594, 0.0512, 1.4494
    bone.roll = -3.1043
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_middle.01.L'] = bone.name
    bone = arm.edit_bones.new('f_ring.01.L')
    bone.head = 0.8159, 0.0778, 1.4507
    bone.tail = 0.8519, 0.0776, 1.4494
    bone.roll = -3.1032
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
    bones['f_ring.01.L'] = bone.name
    bone = arm.edit_bones.new('f_pinky.01.L')
    bone.head = 0.8050, 0.1000, 1.4495
    bone.tail = 0.8366, 0.1010, 1.4483
    bone.roll = -3.1045
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['hand.L']]
