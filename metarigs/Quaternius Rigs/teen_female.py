...
def create(obj):  # noqa
    ...
    bone.head = 0.0000, 0.0394, 0.8040
    bone.tail = 0.0000, 0.0130, 0.9100
    bone.roll = -0.0000
    bone.use_connect = False
    bones['spine'] = bone.name
    bone = arm.edit_bones.new('spine.001')
    bone.head = 0.0000, 0.0130, 0.9100
    bone.tail = 0.0000, 0.0020, 1.0045
    bone.roll = 0.0001
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine']]
    bones['spine.001'] = bone.name
    bone = arm.edit_bones.new('thigh.L')
    bone.head = 0.0961, 0.0447, 0.8146
    bone.tail = 0.0961, 0.0279, 0.4614
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine']]
    ...
    bone.head = 0.0000, 0.0020, 1.0045
    bone.tail = 0.0000, 0.0015, 1.1136
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.001']]
    bones['spine.002'] = bone.name
    bone = arm.edit_bones.new('shin.L')
    bone.head = 0.0961, 0.0279, 0.4614
    bone.tail = 0.0961, 0.0660, 0.0610
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, 0.0015, 1.1136
    bone.tail = 0.0000, 0.0350, 1.2813
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.002']]
    bones['spine.003'] = bone.name
    bone = arm.edit_bones.new('foot.L')
    bone.head = 0.0961, 0.0660, 0.0610
    bone.tail = 0.0961, -0.0533, 0.0128
    bone.roll = 0.0000
    bone.use_connect = True
    ...
    bone.head = 0.0000, 0.0350, 1.2813
    bone.tail = 0.0000, 0.0094, 1.3371
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.003']]
    bones['spine.004'] = bone.name
    bone = arm.edit_bones.new('shoulder.L')
    bone.head = 0.0253, -0.0138, 1.2343
    bone.tail = 0.1184, 0.0383, 1.2342
    bone.roll = 0.0005
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['spine.003']]
    ...
    bone.head = 0.0961, -0.0533, 0.0128
    bone.tail = 0.0961, -0.1121, 0.0128
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['foot.L']]
    bones['toe.L'] = bone.name
    bone = arm.edit_bones.new('heel.02.L')
    bone.head = 0.0671, 0.0664, 0.0000
    bone.tail = 0.1280, 0.0664, 0.0000
    bone.roll = 0.0000
    bone.use_connect = False
    bone.parent = arm.edit_bones[bones['foot.L']]
    ...
    bone.head = 0.0000, 0.0094, 1.3371
    bone.tail = 0.0000, 0.0061, 1.5184
    bone.roll = 0.0000
    bone.use_connect = True
    bone.parent = arm.edit_bones[bones['spine.004']]
    bones['spine.005'] = bone.name
    bone = arm.edit_bones.new('upper_arm.L')
    bone.head = 0.1308, 0.0469, 1.2236
    bone.tail = 0.3382, 0.0507, 1.2236
    bone.roll = 1.5699
    bone.use_connect = False
    ...
    bone.head = 0.3382, 0.0507, 1.2236
    bone.tail = 0.5406, 0.0445, 1.2236
    bone.roll = 1.5708
    bone.use_connect = True
